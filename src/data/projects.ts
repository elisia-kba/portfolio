...
export const projects: Project[] = [
  {
    title: "Todo App",
    description: "Todo List App est une application Vue.js permettant de créer, gérer et filtrer des tâches. Vous pouvez ajouter des tâches avec une description et une date, les marquer comme terminées, les modifier, ou les supprimer.",
